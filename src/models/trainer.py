...
class ModelTrainer:
    ...
    def save_model(
        self, output_path: str, feature_names: List[str], evaluation: Dict, metadata: Dict = None
    ) -> str:
        """
    ...
    def train_pipeline(
        self, df: pd.DataFrame, feature_names: List[str], output_path: str = None
    ) -> Tuple[Dict, str]:
        """
...
def train_maintenance_model(
    df: pd.DataFrame, feature_names: List[str], output_path: str = "models/baseline_model.joblib"
) -> Tuple[Dict, str]:
    """
